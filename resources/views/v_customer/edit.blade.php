    ...
    <div class="col-md-12">
        <div class=" billing-details">
            ...
            <div class="row">
                ...
                <form action="{{ route('customer.update', $edit->user->id) }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pos" value="{{ old('pos', $edit->pos) }}" class="form-control @error('pos') is-invalid @enderror" placeholder="Masukkan Nomor Resi">
                            @error('pos')
                            <span class="invalid-feedback alert-danger" role="alert">
                                {{ $message }}
                            </span>
