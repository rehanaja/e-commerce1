                        ...
                        <div class="row"> 
                            <div class="col-md-4"> 
                                <div class="form-group"> 
                                    ...
                                    {{-- view image --}} 
                                    @if ($edit->foto) 
                                    <img id="preview-foto" src="{{ asset('storage/img-user/' . $edit->foto) }}" class="foto-preview" width="100%"> 
                                    <p></p> 
                                    @else 
                                    <img id="preview-foto" src="{{ asset('storage/img-user/img-default.jpg') }}" class="foto-preview" width="100%"> 
                                    <p></p> 
                                    @endif 
                                    {{-- file foto --}} 
                            ...
                            <div class="col-md-8"> 
                                ...
                                <div class="form-group"> 
                                    <label>Nama</label> 
                                    <input type="text" name="name" value="{{ old('name',$edit->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan Nama"> 
                                    @error('name') 
                                    <span class="invalid-feedback alert-danger" role="alert"> 
                                        {{ $message }} 
                                    </span> 
